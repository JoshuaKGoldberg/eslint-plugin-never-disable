...
<p align="center">ESLint plugin to absolutely definitely ban disabling specific rules. 🙅</p>
...
```shell
npm i eslint-plugin-never-disable
```

```ts
import { greet } from "eslint-plugin-never-disable";
